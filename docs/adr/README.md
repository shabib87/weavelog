...
| ADR-004 | model-selection benchmark policy (seat-weighted composite; HLE protocol pin; L0–L4 reviewer escalation; weekly/monthly drift cadence; reviewer fallback superseded by ADR-007) | superseded | 2026-09-07 |
