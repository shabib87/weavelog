...
- `superpowers/`, `pi-workspace/`, `tbd/` — moved from `docs/` root: historical or
  self-declared non-authoritative. Open questions in `tbd/` re-enter the repo
  as backlog tasks, never by implementing against these files.
- `plans/`, `learnings/`, `specs/2026-08-16-harness-cli-design.md` — see
  `docs/AGENTS.md` for the governing rules.
