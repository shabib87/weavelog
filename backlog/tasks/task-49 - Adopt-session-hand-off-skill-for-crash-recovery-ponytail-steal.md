...
- [ ] #5 WHEN the handoff mechanism is chosen THEN docs/trd/worktree-discipline.md crash contract SHALL gain a pointer to the hand-off artifact as the lightweight complement to manual reset
